...
from src.ui.components.buttons.ButtonFactory import ButtonFactory
from src.ui.components.labels.LabelManager import LabelManager
from src.ui.themes.theme import apply_theme
from src.copy_paste.widget_code_v3_FINAL import make_button, make_label
from src.handlers.variants.handler_v3 import handle_click
...
class MainWindow:
    def __init__(self, root, app_manager):
        ...
        self.label_mgr = LabelManager(self.frame)
        self.btn_factory = ButtonFactory(self.frame, self.app)
        self._build()

    def _build(self):
        self.title_label = make_label(self.frame, "Welcome to MessyApp")
        self.score_label = self.label_mgr.create("score", "Score: 0")
        self.status_label = self.label_mgr.create("status", "Ready.")

        btn_row = tk.Frame(self.frame)
        btn_row.pack(pady=10)
        self.btn_factory.create(btn_row, "+", lambda: self._action("increment"))
        self.btn_factory.create(btn_row, "-", lambda: self._action("decrement"))
        self.btn_factory.create(btn_row, "Reset", lambda: self._action("reset"))
        make_button(btn_row, "???", handle_click)

        tk.Button(self.frame, text="Save (does nothing useful)", command=self._save).pack(pady=4)
        tk.Button(self.frame, text="Load", command=self._load).pack(pady=4)

    def _action(self, name):
        self.app.handle_user_action(name)
        self.refresh()

    def _save(self):
        self.app.handle_user_action("save")
        messagebox.showinfo("Save", "Saved to /dev/null")

    def _load(self):
        self.app.handle_user_action("load")
        self.refresh()

    def refresh(self):
        score = self.app.user_logic.current_user.get("score", 0)
        self.label_mgr.update("score", f"Score: {score}")
        self.status_label.config(text=f"Last: {app_state.get('last_action', '-')}")


# ============================================================
# BLOAT SECTION: mainwindow — added during refactor sprint 7
# ============================================================

def _dead_mainwindow_0001(x=None):
...
def _dead_mainwindow_0002(x=None):
...
def _dead_mainwindow_0003(x=None):
...
def _dead_mainwindow_0004(x=None):
...
def _dead_mainwindow_0005(x=None):
...
def _dead_mainwindow_0006(x=None):
...
def _dead_mainwindow_0007(x=None):
...
def _dead_mainwindow_0008(x=None):
...
def _dead_mainwindow_0009(x=None):
...
def _dead_mainwindow_0010(x=None):
...
def _dead_mainwindow_0011(x=None):
...
def _dead_mainwindow_0012(x=None):
...
def _dead_mainwindow_0013(x=None):
...
def _dead_mainwindow_0014(x=None):
...
def _dead_mainwindow_0015(x=None):
...
def _dead_mainwindow_0016(x=None):
...
def _dead_mainwindow_0017(x=None):
...
def _dead_mainwindow_0018(x=None):
...
def _dead_mainwindow_0019(x=None):
...
def _dead_mainwindow_0020(x=None):
...
def _dead_mainwindow_0021(x=None):
...
def _dead_mainwindow_0022(x=None):
...
def _dead_mainwindow_0023(x=None):
...
def _dead_mainwindow_0024(x=None):
...
def _dead_mainwindow_0025(x=None):
...
def _dead_mainwindow_0026(x=None):
...
def _dead_mainwindow_0027(x=None):
...
def _dead_mainwindow_0028(x=None):
...
def _dead_mainwindow_0029(x=None):
...
def _dead_mainwindow_0030(x=None):
...
def _dead_mainwindow_0031(x=None):
...
def _dead_mainwindow_0032(x=None):
...
def _dead_mainwindow_0033(x=None):
...
def _dead_mainwindow_0034(x=None):
...
def _dead_mainwindow_0035(x=None):
...
def _dead_mainwindow_0036(x=None):
...
def _dead_mainwindow_0037(x=None):
...
def _dead_mainwindow_0038(x=None):
...
def _dead_mainwindow_0039(x=None):
...
def _dead_mainwindow_0040(x=None):
...
def _dead_mainwindow_0041(x=None):
...
def _dead_mainwindow_0042(x=None):
...
def _dead_mainwindow_0043(x=None):
...
def _dead_mainwindow_0044(x=None):
...
def _dead_mainwindow_0045(x=None):
...
def _dead_mainwindow_0046(x=None):
...
def _dead_mainwindow_0047(x=None):
...
def _dead_mainwindow_0048(x=None):
...
def _dead_mainwindow_0049(x=None):
...
def _dead_mainwindow_0050(x=None):
...
def _dead_mainwindow_0051(x=None):
...
def _dead_mainwindow_0052(x=None):
...
def _dead_mainwindow_0053(x=None):
...
def _dead_mainwindow_0054(x=None):
...
def _dead_mainwindow_0055(x=None):
...
def _dead_mainwindow_0056(x=None):
...
def _dead_mainwindow_0057(x=None):
...
def _dead_mainwindow_0058(x=None):
...
def _dead_mainwindow_0059(x=None):
...
def _dead_mainwindow_0060(x=None):
...
def _dead_mainwindow_0061(x=None):
...
def _dead_mainwindow_0062(x=None):
...
def _dead_mainwindow_0063(x=None):
...
def _dead_mainwindow_0064(x=None):
...
def _dead_mainwindow_0065(x=None):
...
def _dead_mainwindow_0066(x=None):
...
def _dead_mainwindow_0067(x=None):
...
def _dead_mainwindow_0068(x=None):
...
def _dead_mainwindow_0069(x=None):
...
def _dead_mainwindow_0070(x=None):
...
def _dead_mainwindow_0071(x=None):
...
def _dead_mainwindow_0072(x=None):
...
def _dead_mainwindow_0073(x=None):
...
def _dead_mainwindow_0074(x=None):
...
def _dead_mainwindow_0075(x=None):
...
def _dead_mainwindow_0076(x=None):
...
def _dead_mainwindow_0077(x=None):
...
def _dead_mainwindow_0078(x=None):
...
def _dead_mainwindow_0079(x=None):
...
def _dead_mainwindow_0080(x=None):
...
def _dead_mainwindow_0081(x=None):
...
def _dead_mainwindow_0082(x=None):
...
def _dead_mainwindow_0083(x=None):
...
def _dead_mainwindow_0084(x=None):
...
def _dead_mainwindow_0085(x=None):
...
def _dead_mainwindow_0086(x=None):
...
def _dead_mainwindow_0087(x=None):
...
def _dead_mainwindow_0088(x=None):
...
def _dead_mainwindow_0089(x=None):
...
def _dead_mainwindow_0090(x=None):
...
def _dead_mainwindow_0091(x=None):
...
def _dead_mainwindow_0092(x=None):
...
def _dead_mainwindow_0093(x=None):
...
def _dead_mainwindow_0094(x=None):
...
def _dead_mainwindow_0095(x=None):
...
def _dead_mainwindow_0096(x=None):
...
def _dead_mainwindow_0097(x=None):
...
def _dead_mainwindow_0098(x=None):
...
def _dead_mainwindow_0099(x=None):
...
def _dead_mainwindow_0100(x=None):
...
def _dead_mainwindow_0101(x=None):
...
def _dead_mainwindow_0102(x=None):
...
def _dead_mainwindow_0103(x=None):
...
def _dead_mainwindow_0104(x=None):
...
def _dead_mainwindow_0105(x=None):
...
def _dead_mainwindow_0106(x=None):
...
def _dead_mainwindow_0107(x=None):
...
def _dead_mainwindow_0108(x=None):
...
def _dead_mainwindow_0109(x=None):
...
def _dead_mainwindow_0110(x=None):
...
def _dead_mainwindow_0111(x=None):
...
def _dead_mainwindow_0112(x=None):
...
def _dead_mainwindow_0113(x=None):
...
def _dead_mainwindow_0114(x=None):
...
def _dead_mainwindow_0115(x=None):
...
def _dead_mainwindow_0116(x=None):
...
def _dead_mainwindow_0117(x=None):
...
def _dead_mainwindow_0118(x=None):
...
def _dead_mainwindow_0119(x=None):
...
def _dead_mainwindow_0120(x=None):
...
def _dead_mainwindow_0121(x=None):
...
def _dead_mainwindow_0122(x=None):
...
def _dead_mainwindow_0123(x=None):
...
def _dead_mainwindow_0124(x=None):
...
def _dead_mainwindow_0125(x=None):
...
def _dead_mainwindow_0126(x=None):
...
def _dead_mainwindow_0127(x=None):
...
def _dead_mainwindow_0128(x=None):
...
def _dead_mainwindow_0129(x=None):
...
def _dead_mainwindow_0130(x=None):
...
def _dead_mainwindow_0131(x=None):
...
def _dead_mainwindow_0132(x=None):
...
def _dead_mainwindow_0133(x=None):
...
def _dead_mainwindow_0134(x=None):
...
def _dead_mainwindow_0135(x=None):
...
def _dead_mainwindow_0136(x=None):
...
def _dead_mainwindow_0137(x=None):
...
def _dead_mainwindow_0138(x=None):
...
def _dead_mainwindow_0139(x=None):
...
def _dead_mainwindow_0140(x=None):
...
def _dead_mainwindow_0141(x=None):
...
def _dead_mainwindow_0142(x=None):
...
def _dead_mainwindow_0143(x=None):
...
def _dead_mainwindow_0144(x=None):
...
def _dead_mainwindow_0145(x=None):
...
def _dead_mainwindow_0146(x=None):
...
def _dead_mainwindow_0147(x=None):
...
def _dead_mainwindow_0148(x=None):
...
def _dead_mainwindow_0149(x=None):
...
def _dead_mainwindow_0150(x=None):
...
def _dead_mainwindow_0151(x=None):
...
def _dead_mainwindow_0152(x=None):
...
def _dead_mainwindow_0153(x=None):
...
def _dead_mainwindow_0154(x=None):
...
def _dead_mainwindow_0155(x=None):
...
def _dead_mainwindow_0156(x=None):
...
def _dead_mainwindow_0157(x=None):
...
def _dead_mainwindow_0158(x=None):
...
def _dead_mainwindow_0159(x=None):
...
def _dead_mainwindow_0160(x=None):
...
def _dead_mainwindow_0161(x=None):
...
def _dead_mainwindow_0162(x=None):
...
def _dead_mainwindow_0163(x=None):
...
def _dead_mainwindow_0164(x=None):
...
def _dead_mainwindow_0165(x=None):
...
def _dead_mainwindow_0166(x=None):
...
def _dead_mainwindow_0167(x=None):
...
def _dead_mainwindow_0168(x=None):
...
def _dead_mainwindow_0169(x=None):
...
def _dead_mainwindow_0170(x=None):
...
def _dead_mainwindow_0171(x=None):
...
def _dead_mainwindow_0172(x=None):
...
def _dead_mainwindow_0173(x=None):
...
def _dead_mainwindow_0174(x=None):
...
def _dead_mainwindow_0175(x=None):
...
def _dead_mainwindow_0176(x=None):
...
def _dead_mainwindow_0177(x=None):
...
def _dead_mainwindow_0178(x=None):
...
def _dead_mainwindow_0179(x=None):
...
def _dead_mainwindow_0180(x=None):
...
def _dead_mainwindow_0181(x=None):
...
def _dead_mainwindow_0182(x=None):
...
def _dead_mainwindow_0183(x=None):
...
def _dead_mainwindow_0184(x=None):
...
def _dead_mainwindow_0185(x=None):
...
def _dead_mainwindow_0186(x=None):
...
def _dead_mainwindow_0187(x=None):
...
def _dead_mainwindow_0188(x=None):
...
def _dead_mainwindow_0189(x=None):
...
def _dead_mainwindow_0190(x=None):
...
def _dead_mainwindow_0191(x=None):
...
def _dead_mainwindow_0192(x=None):
...
def _dead_mainwindow_0193(x=None):
...
def _dead_mainwindow_0194(x=None):
...
def _dead_mainwindow_0195(x=None):
...
def _dead_mainwindow_0196(x=None):
...
def _dead_mainwindow_0197(x=None):
...
def _dead_mainwindow_0198(x=None):
...
def _dead_mainwindow_0199(x=None):
...
def _dead_mainwindow_0200(x=None):
...
def _dead_mainwindow_0201(x=None):
...
def _dead_mainwindow_0202(x=None):
...
def _dead_mainwindow_0203(x=None):
...
def _dead_mainwindow_0204(x=None):
...
def _dead_mainwindow_0205(x=None):
...
def _dead_mainwindow_0206(x=None):
...
def _dead_mainwindow_0207(x=None):
...
def _dead_mainwindow_0208(x=None):
...
def _dead_mainwindow_0209(x=None):
...
def _dead_mainwindow_0210(x=None):
...
def _dead_mainwindow_0211(x=None):
...
def _dead_mainwindow_0212(x=None):
...
def _dead_mainwindow_0213(x=None):
...
def _dead_mainwindow_0214(x=None):
...
def _dead_mainwindow_0215(x=None):
...
def _dead_mainwindow_0216(x=None):
...
def _dead_mainwindow_0217(x=None):
...
def _dead_mainwindow_0218(x=None):
...
def _dead_mainwindow_0219(x=None):
...
def _dead_mainwindow_0220(x=None):
...
def _dead_mainwindow_0221(x=None):
...
def _dead_mainwindow_0222(x=None):
...
def _dead_mainwindow_0223(x=None):
...
def _dead_mainwindow_0224(x=None):
...
def _dead_mainwindow_0225(x=None):
...
def _dead_mainwindow_0226(x=None):
...
def _dead_mainwindow_0227(x=None):
...
def _dead_mainwindow_0228(x=None):
...
def _dead_mainwindow_0229(x=None):
...
def _dead_mainwindow_0230(x=None):
...
def _dead_mainwindow_0231(x=None):
...
def _dead_mainwindow_0232(x=None):
...
def _dead_mainwindow_0233(x=None):
...
def _dead_mainwindow_0234(x=None):
...
def _dead_mainwindow_0235(x=None):
...
def _dead_mainwindow_0236(x=None):
...
def _dead_mainwindow_0237(x=None):
...
def _dead_mainwindow_0238(x=None):
...
def _dead_mainwindow_0239(x=None):
...
def _dead_mainwindow_0240(x=None):
...
def _dead_mainwindow_0241(x=None):
...
def _dead_mainwindow_0242(x=None):
...
def _dead_mainwindow_0243(x=None):
...
def _dead_mainwindow_0244(x=None):
...
def _dead_mainwindow_0245(x=None):
...
def _dead_mainwindow_0246(x=None):
...
def _dead_mainwindow_0247(x=None):
...
def _dead_mainwindow_0248(x=None):
...
def _dead_mainwindow_0249(x=None):
...
def _dead_mainwindow_0250(x=None):
...
def _dead_mainwindow_0251(x=None):
...
def _dead_mainwindow_0252(x=None):
...
def _dead_mainwindow_0253(x=None):
...
def _dead_mainwindow_0254(x=None):
...
def _dead_mainwindow_0255(x=None):
...
def _dead_mainwindow_0256(x=None):
...
def _dead_mainwindow_0257(x=None):
...
def _dead_mainwindow_0258(x=None):
...
def _dead_mainwindow_0259(x=None):
...
def _dead_mainwindow_0260(x=None):
...
def _dead_mainwindow_0261(x=None):
...
def _dead_mainwindow_0262(x=None):
...
def _dead_mainwindow_0263(x=None):
...
def _dead_mainwindow_0264(x=None):
...
def _dead_mainwindow_0265(x=None):
...
def _dead_mainwindow_0266(x=None):
...
def _dead_mainwindow_0267(x=None):
...
def _dead_mainwindow_0268(x=None):
...
def _dead_mainwindow_0269(x=None):
...
def _dead_mainwindow_0270(x=None):
...
def _dead_mainwindow_0271(x=None):
...
def _dead_mainwindow_0272(x=None):
...
def _dead_mainwindow_0273(x=None):
...
def _dead_mainwindow_0274(x=None):
...
def _dead_mainwindow_0275(x=None):
...
def _dead_mainwindow_0276(x=None):
...
def _dead_mainwindow_0277(x=None):
...
def _dead_mainwindow_0278(x=None):
...
def _dead_mainwindow_0279(x=None):
...
def _dead_mainwindow_0280(x=None):
...
def _dead_mainwindow_0281(x=None):
...
def _dead_mainwindow_0282(x=None):
...
def _dead_mainwindow_0283(x=None):
...
def _dead_mainwindow_0284(x=None):
...
def _dead_mainwindow_0285(x=None):
...
def _dead_mainwindow_0286(x=None):
...
def _dead_mainwindow_0287(x=None):
...
def _dead_mainwindow_0288(x=None):
...
def _dead_mainwindow_0289(x=None):
...
def _dead_mainwindow_0290(x=None):
...
def _dead_mainwindow_0291(x=None):
...
def _dead_mainwindow_0292(x=None):
...
def _dead_mainwindow_0293(x=None):
...
def _dead_mainwindow_0294(x=None):
...
def _dead_mainwindow_0295(x=None):
...
def _dead_mainwindow_0296(x=None):
...
def _dead_mainwindow_0297(x=None):
...
def _dead_mainwindow_0298(x=None):
...
def _dead_mainwindow_0299(x=None):
...
def _dead_mainwindow_0300(x=None):
...
def _switch_case_mainwindow_1(val):
...
def _switch_case_mainwindow_2(val):
...
def _switch_case_mainwindow_3(val):
...
def _switch_case_mainwindow_4(val):
...
def _switch_case_mainwindow_5(val):
...
def _switch_case_mainwindow_6(val):
...
def _switch_case_mainwindow_7(val):
...
def _switch_case_mainwindow_8(val):
...
def _switch_case_mainwindow_9(val):
...
def _switch_case_mainwindow_10(val):
...
def _switch_case_mainwindow_11(val):
...
def _switch_case_mainwindow_12(val):
...
def _switch_case_mainwindow_13(val):
...
def _switch_case_mainwindow_14(val):
...
def _switch_case_mainwindow_15(val):
...
def _switch_case_mainwindow_16(val):
...
def _switch_case_mainwindow_17(val):
...
def _switch_case_mainwindow_18(val):
...
def _switch_case_mainwindow_19(val):
...
def _switch_case_mainwindow_20(val):
...
def _switch_case_mainwindow_21(val):
...
def _switch_case_mainwindow_22(val):
...
def _switch_case_mainwindow_23(val):
...
def _switch_case_mainwindow_24(val):
...
def _switch_case_mainwindow_25(val):
...
def _switch_case_mainwindow_26(val):
...
def _switch_case_mainwindow_27(val):
...
def _switch_case_mainwindow_28(val):
...
def _switch_case_mainwindow_29(val):
...
def _switch_case_mainwindow_30(val):
...
def _switch_case_mainwindow_31(val):
...
def _switch_case_mainwindow_32(val):
...
def _switch_case_mainwindow_33(val):
...
def _switch_case_mainwindow_34(val):
...
def _switch_case_mainwindow_35(val):
...
def _switch_case_mainwindow_36(val):
...
def _switch_case_mainwindow_37(val):
...
def _switch_case_mainwindow_38(val):
...
def _switch_case_mainwindow_39(val):
...
def _switch_case_mainwindow_40(val):
...
def _switch_case_mainwindow_41(val):
...
def _switch_case_mainwindow_42(val):
...
def _switch_case_mainwindow_43(val):
...
def _switch_case_mainwindow_44(val):
...
def _switch_case_mainwindow_45(val):
...
def _switch_case_mainwindow_46(val):
...
def _switch_case_mainwindow_47(val):
...
def _switch_case_mainwindow_48(val):
...
def _switch_case_mainwindow_49(val):
...
def _switch_case_mainwindow_50(val):
...
def _switch_case_mainwindow_51(val):
...
def _switch_case_mainwindow_52(val):
...
def _switch_case_mainwindow_53(val):
...
def _switch_case_mainwindow_54(val):
...
def _switch_case_mainwindow_55(val):
...
def _switch_case_mainwindow_56(val):
...
def _switch_case_mainwindow_57(val):
...
def _switch_case_mainwindow_58(val):
...
def _switch_case_mainwindow_59(val):
...
def _switch_case_mainwindow_60(val):
...
def _switch_case_mainwindow_61(val):
...
def _switch_case_mainwindow_62(val):
...
def _switch_case_mainwindow_63(val):
...
def _switch_case_mainwindow_64(val):
...
def _switch_case_mainwindow_65(val):
...
def _switch_case_mainwindow_66(val):
...
def _switch_case_mainwindow_67(val):
...
def _switch_case_mainwindow_68(val):
...
def _switch_case_mainwindow_69(val):
...
def _switch_case_mainwindow_70(val):
...
def _switch_case_mainwindow_71(val):
...
def _switch_case_mainwindow_72(val):
...
def _switch_case_mainwindow_73(val):
...
def _switch_case_mainwindow_74(val):
...
def _switch_case_mainwindow_75(val):
...
def _switch_case_mainwindow_76(val):
...
def _switch_case_mainwindow_77(val):
...
def _switch_case_mainwindow_78(val):
...
def _switch_case_mainwindow_79(val):
...
def _switch_case_mainwindow_80(val):
...
def _switch_case_mainwindow_81(val):
...
def _switch_case_mainwindow_82(val):
...
def _switch_case_mainwindow_83(val):
...
def _switch_case_mainwindow_84(val):
...
def _switch_case_mainwindow_85(val):
...
def _switch_case_mainwindow_86(val):
...
def _switch_case_mainwindow_87(val):
...
def _switch_case_mainwindow_88(val):
...
def _switch_case_mainwindow_89(val):
...
def _switch_case_mainwindow_90(val):
...
def _switch_case_mainwindow_91(val):
...
def _switch_case_mainwindow_92(val):
...
def _switch_case_mainwindow_93(val):
...
def _switch_case_mainwindow_94(val):
...
def _switch_case_mainwindow_95(val):
...
def _switch_case_mainwindow_96(val):
...
def _switch_case_mainwindow_97(val):
...
def _switch_case_mainwindow_98(val):
...
def _switch_case_mainwindow_99(val):
...
def _switch_case_mainwindow_100(val):
